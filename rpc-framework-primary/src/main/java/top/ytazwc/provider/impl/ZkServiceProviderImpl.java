...
public class ZkServiceProviderImpl implements ServiceProvider {
    ...
    public ZkServiceProviderImpl() {
        ...
        serviceRegistry = ExtensionLoader.getExtensionLoader(ServiceRegistry.class).getExtension(ServiceRegistryType.ZK.getName());
    }
